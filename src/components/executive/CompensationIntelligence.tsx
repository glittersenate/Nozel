...
const CompensationIntelligence: React.FC = () => (
  <Card className="bg-gradient-to-tr from-emerald-900/80 to-blue-900/70 border-emerald-800/40 shadow-md h-full">
    <CardHeader>
      ...
      <p className="text-blue-200/70 text-xs mt-1">
        Benchmark payroll, salary, and benefits against market data.
      </p>
    </CardHeader>
    <CardContent>
      <div className="text-blue-100 mt-1">
        <span className="text-emerald-300/80 text-sm">AI-powered compensation benchmarking coming soon.</span>
      </div>
    </CardContent>
  </Card>
);

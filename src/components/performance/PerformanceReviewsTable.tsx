...
export const PerformanceReviewsTable = () => {
  ...
  return (
    <>
      <ReviewDetailDialog review={selectedReview} open={detailOpen} onOpenChange={setDetailOpen} />
      <EditReviewDialog review={selectedReview} open={editOpen} onOpenChange={setEditOpen} />

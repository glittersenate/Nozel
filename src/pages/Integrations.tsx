  ...
  <div className="min-h-screen bg-background">
    <div className="pt-8 pb-12 px-4 lg:pl-16 lg:pr-0 w-full">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl sm:text-3xl font-extrabold text-foreground bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
          Integrations
        </h1>
      </div>
      <p className="mb-7 text-muted-foreground text-base">
